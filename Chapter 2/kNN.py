...
def classifyPerson():
    ...
    classifyResult = classify0((inArr - minVals)
...
def handwritingClassTest():
    ...
    for i in range(m):
        ...
        fileSrt = fileNameStr.split('.')[0]
        classNumStr = int(fileSrt.split('_')[0])
    ...
    for i in range(mTest):
        ...
        print("the classifier came back with: %d, the real answer is: %d"
              % (classifierResult, classNumStr), file=f)
      #  c = "the classifier came back with:"+ str(int(classifierResult)) + "the real answer is: "+ str(int(classNumStr))
